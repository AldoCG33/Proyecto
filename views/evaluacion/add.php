            ...
            <div class="mb-2">
                ...
                <form method="post" >
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="come" id="come" placeholder="Escriba la evaluciacion" required >
                    </div>
...
if (isset($_POST['registrar'])) {
    ...
    $resultado = mysqli_real_escape_string($cone, $_POST['cbx_res']);
        ...
        $registro = "INSERT INTO evaluacion (Puntaje,id_resultado) VALUES ('$puntaje', '$resultado')";
            ...
            if ($r) { ?> 
                   ...
                   <div class="alert alert-success alert-dismissible">
                             <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                Se agrego la evaluacion exitosamente 
                    </div>
