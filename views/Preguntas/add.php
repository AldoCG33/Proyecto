            ...
            <div class="mb-2">
                ...
                <form method="post" >
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="come" id="come" placeholder="Escriba la pregunta " required >
                    </div>
...
if (isset($_POST['registrar'])) {
    ...
    $resu = mysqli_real_escape_string($cone, $_POST['cbx_cali']);
        ...
        $registro = "INSERT INTO preguntas (Id_usuario, Preguntas, id_evaluacion ) VALUES ('$usuario', '$pregunta','$resu')";
